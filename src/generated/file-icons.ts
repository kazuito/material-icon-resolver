...
export const fileNames: Record<string, string> = {
	...
	"application-dev.yaml": "yaml",
	"application-dev.yml": "yaml",
	"application-prod.properties": "settings",
	"application-prod.yaml": "yaml",
	"application-prod.yml": "yaml",
	"application-test.properties": "settings",
	"application-test.yaml": "yaml",
	...
	"docker-bake.hcl": "docker",
	"docker-bake.json": "docker",
	...
	"requirements-test.txt": "python-misc",
...
export const fileNamesWithPath: Record<string, string> = {
